        ...
        <article className="prose prose-invert mt-10 max-w-full space-y-10 text-muted-foreground prose-headings:font-semibold prose-headings:text-foreground prose-p:leading-relaxed prose-li:marker:text-primary">
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              California Consumer Privacy Act of 2018 (Cal. Civ. Code § 1798.100 et seq.) and the California Privacy
              Rights Act of 2020 (&quot;CCPA/CPRA&quot;) for users who are California residents.
            </p>
            <p className="mt-4">
              <strong className="text-foreground">GDPR rights.</strong> If you are located in the EEA or UK, you have
              the right to: (i) access the personal data we hold about you; (ii) request correction of inaccurate personal
              data; (iii) request erasure of your personal data, subject to applicable legal obligations; (iv) object to
              or request restriction of certain processing activities; (v) request portability of your personal data in a
              structured, machine-readable format; and (vi) withdraw consent at any time where processing is based on
              consent, without affecting the lawfulness of prior processing. To exercise any of these rights, please
              contact us using the notice contact details in{' '}
              <Link href="#notices" className="text-primary underline underline-offset-2 hover:no-underline">
                Section 20.6 (Notices)
              </Link>{' '}
              below or as described in our{' '}
              <Link href="/privacy" className="text-primary underline underline-offset-2 hover:no-underline">
                Privacy Policy
              </Link>
            ...
            <p className="mt-4">
              <strong className="text-foreground">CCPA/CPRA rights.</strong> If you are a California resident, you
              have the right to: (i) know what personal information we collect, use, disclose, or sell; (ii) request
              deletion of your personal information, subject to applicable exceptions; (iii) opt out of the sale or
              sharing of your personal information; (iv) correct inaccurate personal information we hold about you; and
              (v) limit the use and disclosure of sensitive personal information. Circe et Venus Inc. does not sell
              personal information as defined under the CCPA/CPRA. We do not discriminate against users who exercise
              their privacy rights. To submit a verifiable consumer request, please contact us using the notice contact
              details in{' '}
              <Link href="#notices" className="text-primary underline underline-offset-2 hover:no-underline">
                Section 20.6 (Notices)
              </Link>{' '}
            ...
            <p className="mt-4">
              <strong className="text-foreground">General.</strong> Personal data collected through this Service is
              processed only for the purposes described in our{' '}
              <Link href="/privacy" className="text-primary underline underline-offset-2 hover:no-underline">
                Privacy Policy
              </Link>
              ...
              retain personal data only for as long as necessary to fulfill the purposes for which it was collected or as
              required by applicable law. Users who believe their data protection rights have been violated may lodge a
              complaint with the relevant supervisory authority in their jurisdiction.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 id="notices" className="mt-6 text-lg font-medium text-foreground scroll-mt-24">
              20.6 Notices
            </h3>
            <p>
              ...
              . Privacy-related and data-protection requests may also be directed to{' '}
              <a href="mailto:admin@circeetvenus.com" className="text-primary underline underline-offset-2">
                admin@circeetvenus.com
              </a>{' '}
              or via the contact and data-request options described in the{' '}
              <Link href="/privacy" className="text-primary underline underline-offset-2 hover:no-underline">
                Privacy Policy
              </Link>
              .
