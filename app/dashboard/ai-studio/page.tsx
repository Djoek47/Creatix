  ...
  return (
    <div className="min-w-0 space-y-5">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-5">
        <div className="flex w-full flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-stretch sm:gap-2">
          <TabsList className="grid h-auto w-full min-w-0 flex-1 grid-cols-2 gap-2 bg-transparent p-0 sm:inline-flex sm:w-auto sm:min-w-0 sm:gap-2">
            <TabsTrigger
              value="library"
          ...
          <VideoEditorToolbarButton className="w-full shrink-0 sm:w-auto" />
        </div>
