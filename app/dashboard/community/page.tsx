    ...
    <div className="space-y-8 p-4 pb-12 sm:p-6">
      ...
      {LOCK_COMMUNITY_TIPS_FOR_BETA ? (
        <div className="relative">
          ...
          <div
            className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 rounded-2xl bg-background/65 p-6 text-center backdrop-blur-sm"
            role="status"
            aria-live="polite"
          >
            ...
            <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">
              Community tips are in beta for now. <span className="text-foreground/90">Circe daily</span> above stays
