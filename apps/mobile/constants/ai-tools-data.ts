...
export const ALL_TOOLS_META: AIToolMeta[] = [
  ...
  { id: 'aesthetic-matcher', name: 'Aesthetic Matcher', description: 'Trending styles & brand cohesion', longDescription: 'Describe your current look and platform; get trending aesthetic directions, palettes, mood keywords, and practical editing tips.', category: 'content', credits: 1, hasRunner: true },
