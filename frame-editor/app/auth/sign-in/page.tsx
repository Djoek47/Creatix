...
export default function SignInPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center px-4">
      ...
      <Link
        href={CREATIX}
        className="text-muted-foreground hover:text-foreground absolute left-6 top-6 text-sm"
      >
        ← Circe et Venus
      </Link>

      <div className="mb-8 flex flex-col items-center gap-3 text-center">
        <h1 className="font-serif-display text-primary tracking-widest">CIRCE ET VENUS</h1>
        <p className="text-muted-foreground text-xs uppercase tracking-wider">Frame — video bridge</p>
      </div>
      ...
      >
        ...
        <p className="text-muted-foreground mb-6 text-sm">
          Use the same account as the main site. A <strong>paid plan</strong> is required to open Frame without a
          vault bridge link.
        </p>
        ...
        <p className="text-muted-foreground mt-6 text-center text-xs">
          Need a subscription?{' '}
          <a href={`${CREATIX}/dashboard/settings`} className="text-[var(--circe-light)] underline">
