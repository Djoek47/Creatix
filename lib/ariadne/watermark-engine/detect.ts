import { decodeWithParity, majorityVote } from '@/lib/ariadne/watermark-engine/ecc'
import type { GrayFrame, WatermarkDetectOptions, WatermarkDetectResult } from '@/lib/ariadne/watermark-engine/types'
