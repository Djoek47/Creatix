/**
 * Archived Creatix product-workflow tips (v1: sync, Divine, messages, analytics).
 * Superseded by the OnlyFans / creator-economy insight set in `circe-daily-tips-of-insights.ts`.
 * Not shown in the daily rotation; kept for reference, support, and possible re-import.
 */

export const CIRCE_DAILY_TIPS_LEGACY = [
  {
    id: 'sync-first',
...
export type CirceLegacyTip = (typeof CIRCE_DAILY_TIPS_LEGACY)[number]
