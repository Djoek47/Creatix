...
> = {
  ...
  'full-02': { subjectLabel: 'How it fits', theme: 'neutral', iconKey: 'Map' },
  ...
  'full-10': { subjectLabel: 'AI Studio', theme: 'aurora', iconKey: 'Wand2' },
  'full-11': { subjectLabel: 'Tools & credits', theme: 'aurora', iconKey: 'Zap' },
  'full-12': { subjectLabel: 'Chatter & gifts', theme: 'venus', iconKey: 'Bot' },
  'full-13': { subjectLabel: 'Circe vs Venus', theme: 'circe', iconKey: 'GitMerge' },
  'full-14': { subjectLabel: 'Analytics', theme: 'circe', iconKey: 'BarChart3' },
  'full-15': { subjectLabel: 'Income Predictor', theme: 'circe', iconKey: 'TrendingUp' },
  'full-16': { subjectLabel: 'Retention & churn', theme: 'circe', iconKey: 'Moon' },
  'full-17': { subjectLabel: 'Churn Predictor (tool)', theme: 'circe', iconKey: 'Wand2' },
  'full-18': { subjectLabel: 'Protection', theme: 'circe', iconKey: 'Shield' },
  'full-19': { subjectLabel: 'Aegis', theme: 'circe', iconKey: 'ShieldCheck' },
  'full-20': { subjectLabel: 'Fans', theme: 'venus', iconKey: 'Users' },
  'full-21': { subjectLabel: 'Fan classification', theme: 'venus', iconKey: 'Filter' },
  'full-22': { subjectLabel: 'Commenter', theme: 'venus', iconKey: 'MessageCircle' },
