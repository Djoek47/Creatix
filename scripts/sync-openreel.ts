...
async function applyMarkitCompatibilityPatches() {
  ...
  await replaceInFile(
    "web/services/highlight-service.ts",
    /import\.meta\.env\.VITE_CLOUD_API_URL/g,
    "process.env.NEXT_PUBLIC_OPENREEL_CLOUD_API_URL",
  );

  await replaceInFile(
    "web/main.tsx",
    /import\.meta\.env\.VITE_PUBLIC_POSTHOG_KEY/g,
    "process.env.NEXT_PUBLIC_POSTHOG_KEY",
  );

  await replaceInFile(
    "web/main.tsx",
    /import\.meta\.env\.VITE_PUBLIC_POSTHOG_HOST/g,
