...
interface ORSpeechRecognitionResult {
  readonly isFinal: boolean;
  readonly length: number;
  [index: number]: ORSpeechRecognitionAlternative;
}

interface ORSpeechRecognitionAlternative {
  readonly transcript: string;
  readonly confidence: number;
}

interface ORSpeechRecognitionResultList {
  readonly length: number;
  [index: number]: ORSpeechRecognitionResult;
}

interface ORSpeechRecognitionEvent extends Event {
  readonly results: ORSpeechRecognitionResultList;
  readonly resultIndex: number;
}

interface ORSpeechRecognitionErrorEvent extends Event {
  readonly error: string;
  readonly message: string;
}

interface ORSpeechRecognitionInstance extends EventTarget {
  lang: string;
  continuous: boolean;
  interimResults: boolean;
  maxAlternatives: number;
  onresult: ((event: ORSpeechRecognitionEvent) => void) | null;
  onerror: ((event: ORSpeechRecognitionErrorEvent) => void) | null;
  onend: (() => void) | null;
  start(): void;
  stop(): void;
  abort(): void;
...
interface ORSpeechRecognitionConstructor {
  new (): ORSpeechRecognitionInstance;
}
...
export class SpeechToTextEngine {
  private recognition: ORSpeechRecognitionInstance | null = null;
  ...
  private initRecognition(): void {
    ...
    const speechWindow = window as unknown as {
      SpeechRecognition?: ORSpeechRecognitionConstructor;
      webkitSpeechRecognition?: ORSpeechRecognitionConstructor;
    };
  ...
  private setupRecognitionHandlers(): void {
    ...
    this.recognition.onresult = (event: ORSpeechRecognitionEvent) => {
    ...
    this.recognition.onerror = (event: ORSpeechRecognitionErrorEvent) => {
